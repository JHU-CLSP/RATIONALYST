...
for i in range(len(cot_lines)):
    ...
    # if (d_cot["answer"] == d_cot["normalized_prediction"] or d_cot["normalized_answer"] == d_cot["normalized_prediction"]) and d_cot["normalized_prediction"] != '':
    if (d_cot["normalized_answer"] == d_cot["normalized_prediction"]) and d_cot["normalized_prediction"] != '':
        correct += 1
    # else:
