...
write_file_train, write_file_dev = open('llm_training_data_filtered_train_new_without_final_all.jsonl', 'w'), open('llm_training_data_filtered_dev_new_without_final_all.jsonl', 'w')
# split the data into training and dev, don't do any more operation, just split 95% to training and 5% to dev
lines = open("llm_training_data_filtered_new_without_final.jsonl").readlines()
